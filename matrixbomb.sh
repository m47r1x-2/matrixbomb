...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        echo -e "\e[1;33mCreated By \e[1;32m""\e[41m"
        toilet -f mono12 -F border MATRIX
        
    fi
    echo -e "\e[1;32m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/matrixworld \e[0m"
    echo -e "\e[4;32m   YouTube: https://youtu.be/U_sDn7ifzFM \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of matrixbomb for more stability."
    echo " "
}
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;32m   Subscribe MATRIX Youtube Channel"
        sleep 5
        cd $HOME
        cd matrixbomb
        python3 bomber.py
